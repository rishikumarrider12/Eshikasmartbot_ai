...
async function sendMessage() {
  ...
  try {
    ...
    if (isLocal) {
      ...
      const LOCAL_KEY = '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'; 
      ...
      const messages = [
        {
          role: "system",
          content: "You are Eshika SmartBot AI.\n- Founder: N Rishikumar (Son of N Chiranjeevi).\n- CEO & Founder of Eshika: P Raghu Varma.\n- Developed by: Eshika Developers Team.\nMaintain a professional, helpful tone. Mention your origins or founder ONLY if specifically asked about your creation or identity. Do not repeat this information in every response."
        }
      ];
      ...
      if (data.choices && data.choices[0]) {
        // Map Groq response to Gemini-like format for consistency in the next block
        responseBody = {
          candidates: [{
            content: {
